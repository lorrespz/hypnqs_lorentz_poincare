...
# This code defines the Lorentz wavefunction that combines LorentzRNN/GRU with Dense layers
# The LorentzGRU class in this file uses the manifold update method

import torch
import torch.nn as nn
import torch.nn.functional as F
#from j1j2_definitions_tangent_update import *# LorentzGRU with tangent space update
from j1j2_definitions_manifold_update import * # LorentzGRU with manifold update
import numpy as np
import random

# Earlier training for LorentzRNN with single clamp:
norm_spatial = 18.0
# Default value: 20 (LorentzRNN w double clamp) + LorentzGRU
#norm_spatial = 20.0
...
class wfModel(nn.Module):
    ...
    def forward(self, inputs, rnn_state, compute_phase):        
        ...
        #rnn_output =project_lorentz_soft(rnn_output, k=1.0)
...
class Lorentzwavefunction(object):
    def __init__(self, systemsize, cell_type, units, spatial_clamp = 4.0, seed=111):
        self.N = systemsize
        self.inputdim = 2
