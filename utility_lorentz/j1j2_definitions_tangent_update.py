...
# The LorentzGRU class in this file uses the tangent update method

from util_loading import *

# use 20.0 for double clamp case
#norm_spatial = 20
# use 18.0 for single clamp case (uncomment the line below)
norm_spatial = 18.0
...
class LorentzRNN(nn.Module):
    ...
    def forward(self, inputs, state):
        ...
        # use the line below for double clamp, comment out for single clamp
    ...
    def get_manifold_parameters(self):
        # Euclidean because they act as transformation matrices
        eucl_vars = [self.W, self.U]
        
        # Hyperbolic because it represents a point 
...
class LorentzGRU(nn.Module):
    ...
    def forward(self, inputs, state):
        ...
        #--------------------------------------------------------------------------------
        # Option 1: Manifold update (see j1j2_definitions_manifold_update.py)
        #--------------------------------------------------------------------------------
        #---------------------------------------------------------------------------------
