...
# This code defines the train loop for J1J2 model (with no tau in the sample method) using Lorentz NQS.
...
def train_step(wf, N, numsamples, J1, J2, Bz, Marshall_sign, opt_eucl, opt_hyp):
    ...
    try:
        ...
        tsamp = wf.sample_no_tau(numsamples) 
        ...
        # Lowering these limits is necessary for J1-J2 frustration
