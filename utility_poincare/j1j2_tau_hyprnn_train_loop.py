...
# This code defines the J1J2 training loop for either Euclidean GRU/RNN NQS or Poincare RNN/GRU NQS
...
from j1j2_tau_hyprnn_wf import *
...
def run_J1J2(wf, numsteps, systemsize, var_tol, J1_=1.0, J2_=0.0, Marshall_sign=True, 
    ...
    for step in range(numsteps):
        ...
        if step % 10 == 0:        
            ...
            if hyp_vars:
                # Access the buffer from model's RNN layer
