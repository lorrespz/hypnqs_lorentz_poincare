...
# This code defines the NQS wavefunction (J1J2 model) using either Euclidean GRU/RNN or Poincare RNN/GRU combined with Dense layers.
# The `sample' method contains the temperature scaling parameter `tau'

import torch
import torch.nn as nn
import torch.nn.functional as F
from j1j2_poincare_definitions import *
import numpy as np
import random
...
class RNNwavefunction(object):
    ...
    def sample(self, numsamples):
        ...
        for n in range(self.N):
            ...
            # apply a small temperature tau to encourage exploration
            #(tau > 1.0 increases exploration, tau=1.0 original training)
            ...
            # Re-normalize to satisfy multinomial's sum constraint
